...
namespace TestProject1
{
    public class Tests
    {
        ...
        {
            Driver.Navigate().GoToUrl("https://monitoringmvcwebapp.azurewebsites.net/");
        ...
        public void User_Button_Routes_To_Correct_Page()
        {
            ...
            Assert.That(Driver.Url == "https://monitoringmvcwebapp.azurewebsites.net/Identity/Account/Login?ReturnUrl=%2FUser%2FIndex");
        ...
        public void Admin_Button_Routes_To_Correct_Page()
        {
            ...
            Assert.That(Driver.Url == "https://monitoringmvcwebapp.azurewebsites.net/Identity/Account/Login?ReturnUrl=%2FAdmin%2FIndex");
        ...
        {
            Driver.Navigate().GoToUrl("https://monitoringmvcwebapp.azurewebsites.net/Identity/Account/Register");
        ...
        public void Delete_User_Method()
        {
            ...
            Driver.Navigate().GoToUrl("https://monitoringmvcwebapp.azurewebsites.net/Identity/Account/Login?ReturnUrl=%2FAdmin");
